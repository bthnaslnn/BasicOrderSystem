...
export class CustomerComponent implements AfterViewInit, OnInit {
	...
	displayedColumns: string[] = ['id', 'createdUserId', 'createdDate', 'lastUpdatedUserId', 'lastUpdatedDate', 'status', 'isDeleted', 'customerName', 'customerCode', 'address', 'phoneNum', 'email', 'update', 'delete'];
	...
	createCustomerAddForm() {
		this.customerAddForm = this.formBuilder.group({
			...
			phoneNum: [0, Validators.required],
